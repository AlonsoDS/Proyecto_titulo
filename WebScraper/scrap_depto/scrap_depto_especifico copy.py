...
#urls = ["https://portalinmobiliario.com/MLC-2835365654",#find
 #       "https://portalinmobiliario.com/MLC-1579896453"]#find_all

urls = ["https://portalinmobiliario.com/MLC-2835365654"]
#el primero 
#el segundo 
...
for url in urls:
    try:
        ...
        if response.status_code==403:
            print("Error 403 a las:",datetime.now())
            print("Link numero:", i)
            #implementar una logica para pausar la ejecucion y registrar el progreso
        ...
        print(caracteristicas_container)
        ...
        line = tb_list[-1][1]
        print(f"Error con el link {url}: {str(e)}. Linea {line}")
